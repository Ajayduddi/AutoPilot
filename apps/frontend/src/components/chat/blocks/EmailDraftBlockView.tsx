/**
 * @fileoverview Rich email draft block view with preview and interaction
 *
 * High-level purpose:
...
/**
 * Internal renderer for a single normalized email draft.
 */
...
/**
 * Renders one or multiple assistant email drafts split from block payload.
 *
 * @remarks
 * Multi-draft payloads are displayed sequentially with optional separators
 * to preserve model-authored variant grouping.
 */
