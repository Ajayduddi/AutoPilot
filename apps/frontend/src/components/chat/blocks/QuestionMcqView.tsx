/**
 * @fileoverview apps/frontend/src/components/chat/blocks/QuestionMcqView.tsx
 *
 * High-level purpose:
...
import { isWorkflowProceedPrompt } from "./question-mcq-utils";
...
export { isWorkflowProceedPrompt };
