/**
 * @fileoverview apps/frontend/src/components/settings/types.ts
 *
 * High-level purpose:
...
export const settingsCls = {
  ...
  sectionCard: "",
  subCard: "rounded-none md:rounded-2xl border border-transparent md:border-neutral-800/40 bg-transparent md:bg-[#151515]",
  rowCard: "rounded-none md:rounded-xl border border-transparent md:border-neutral-800/40 bg-transparent md:bg-[#161616] shadow-none",
  field:
...
export const unifiedCallbackUrl = `${API_BASE_URL}/api/webhooks/callback`;
