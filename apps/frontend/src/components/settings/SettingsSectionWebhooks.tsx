/**
 * @fileoverview apps/frontend/src/components/settings/SettingsSectionWebhooks.tsx
 *
 * High-level purpose:
...
import { settingsCls, unifiedCallbackUrl, unifiedExample, type WebhookSecretRecord } from "./types";
